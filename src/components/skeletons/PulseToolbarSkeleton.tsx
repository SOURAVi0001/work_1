            ...
            <div className="hidden lg:block">
                ...
                <div className="flex items-center justify-between px-4 lg:px-5 py-2 overflow-visible gap-4 mt-2">
                    <div className="flex items-center gap-1 shrink-0">
                        <div className="w-[38px] h-[22px] bg-[#1a1b23] rounded" /> {}
                        <div className="w-24 h-[22px] bg-[#1a1b23] rounded-full" /> {}
                    </div>

                    <div className="flex items-center gap-2.5 shrink-0">
                        <div className="w-6 h-6 bg-[#1a1b23] rounded p-1" /> {}
                        ...
                        <div className="w-[100px] h-[26px] bg-[#1a1b23] rounded-full" /> {}
                    </div>
                </div>
            </div>
